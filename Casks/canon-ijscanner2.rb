cask "canon-ijscanner2" do
  ...
  url "https://gdlp01.c-wss.com/gds/9/0100006579/03/misd-mac-ijscanner2-#{version.before_comma.dots_to_underscores.delete_suffix("a")}-ea#{version.after_comma}.dmg",
