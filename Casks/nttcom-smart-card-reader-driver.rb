cask 'nttcom-smart-card-reader-driver' do
  ...
  url "https://www.ntt.com/content/dam/nttcom/hq/jp/business/services/application/authentication/jpki/etc/AcrMacDriver#{version}.dmg",
      user_agent: :fake
  name 'NTTCom Smart Card Reader Driver'
  homepage 'https://www.ntt.com/business/services/application/authentication/jpki.html'
