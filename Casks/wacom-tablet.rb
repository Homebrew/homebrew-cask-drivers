cask "wacom-tablet" do
  ...
  uninstall pkgutil:   "com.wacom.TabletInstaller",
            ...
            launchctl: [
              regex(/(?:application\.)?com\.wacom\.TabletDriver(?:(?:\.\d+){2}(?:\[\w-]+))?/),
              regex(/(?:application\.)?com\.wacom\.UpgradeHelper(?:(?:\.\d+){2}(?:\[\w-]+))?/),
              regex(/(?:application\.)?com\.wacom\.WacomCenter(?:(?:\.\d+){2}(?:\[\w-]+))?/),
              regex(/(?:application\.)?com\.wacom\.WacomExperienceProgram(?:(?:\.\d+){2}(?:\[\w-]+))?/),
