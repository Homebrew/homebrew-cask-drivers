cask 'anker-rtunic' do
  ...
  url "https://#{version.after_comma.before_colon}.cloudfront.net/spree/accessories/attachments/70581/RTUNICv#{version.before_comma}_disable_flowcontrol_1.zip?#{version.after_colon}"
  name 'Anker RTUNIC'
