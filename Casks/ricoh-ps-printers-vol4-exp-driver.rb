cask "ricoh-ps-printers-vol4-exp-driver" do
  ...
  url "https://support.ricoh.com/bb/pub_e/dr_ut_e/0001316/0001316696/V#{version.delete(".")}/Ricoh_PS_Printers_Vol4_EXP_LIO_#{version}.dmg"
  name "Ricoh PS printers Vol 4 EXP driver"
  homepage "https://support.ricoh.com/bb/html/dr_ut_e/rc3/model/mpc3004ex/mpc3004ex.htm"
