cask "bose-usb-link-updater" do
  ...
  url "https://assets.bose.com/content/dam/Bose_DAM/Web/pro/software/bose_work/700uc/#{version.dots_to_underscores}/Bose-USB-Link-Updater-Mac-#{version}.pkg.zip"
  ...
  uninstall quit:    "com.bose.pro.conf.usblinkupdater",
            pkgutil: "com.bose.pro.conf.usblinkupdater"
