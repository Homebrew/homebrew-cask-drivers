cask "canon-ijscanner15f" do
  ...
  url "https://gdlp01.c-wss.com/gds/3/0100006713/04/misd-mac-ijscanner15f-#{version.before_comma.dots_to_underscores.delete_suffix("a")}-ea#{version.after_comma}.dmg",
